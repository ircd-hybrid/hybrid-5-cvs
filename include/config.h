 ...
 *
 * $Id: config.h,v 1.21.4.9 2000/07/29 17:02:36 lusky Exp $
 */
...
/* MAX_SERVER_SPLIT_RECOVERY_TIME is the amount of time to wait after a server
 * rejoins the network before allowing chanops new channels.  If you are using
 * SPLIT_PONG, it's safe to set down to 1 minute.
 */
#define MAX_SERVER_SPLIT_RECOVERY_TIME 1
