 ...
 *
 * $Id: s_err.h,v 1.5 1998/07/09 03:39:43 db Exp $
 *
 */
...
/* 263 */       RPL_LOAD2HI, ":%s 263 %s :Hold your horses... the server load is temporarily too heavy. Try again later, ok?",
/* 264 */	0, (char *)NULL,
...
/* 379 */	0, (char *)NULL,
/* 380 */	0, (char *)NULL,
/* 381 */	RPL_YOUREOPER, ":%s 381 %s :You are now one bad motherfuck - Go /kill someone.",
/* 382 */	RPL_REHASHING, ":%s 382 %s %s :it slices, dices, and even reload config files! Rehashing config file, mang.",
/* 383 */	0, (char *)NULL,
...
/* 502 */	ERR_USERSDONTMATCH, ":%s 502 %s :You can't change user modes for other users, silly - check that nickname again.",
